...
if __name__ == "__main__":
    ...
    data_path = DATA_DIR / "current_layout_idx.npy"
    print(data_path)
    start_layout = np.load(data_path)
    ...
    save_layout_map(_xy_all, candidate_xy=None, best_solution=best_solution,
                    out_path="outputs/optimised_layout_map.png")
