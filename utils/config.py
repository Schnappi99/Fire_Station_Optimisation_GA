...
config = {
    ...
    #
    "station_distance_threshold_km": 10.0,
    "speed_mph": 30.0,
    ...
    "gene_space_top_pct": ["40%", "30%", "20%", "10%"],# Top X% of demand cells considered (used in sweep runs)

    #  Initial population parameters
    "method_mode": ["balanced_init", "local_init", "random_init"],                # Initialisation mode: "mixed", "single_swap", or "random"
    "n_one_step_neighbors": 100,                                                  # Number of baseline neighbours generated by changing one station at a time
